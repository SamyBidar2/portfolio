...
export const Navlinks = () => {
  ...
  const scrollWithOffset = (el) => {
    ...
    const yOffset = -70; // La hauteur de votre navbar
      ...
      <Container style={{ borderBottom: '1px solid white', paddingBottom: '10px' }}>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            >
              <Nav.Link as={Link} className='text-light' to="/#portfolio" scroll={scrollWithOffset}>Projets</Nav.Link>
            </motion.div>
            <motion.div
              initial={{ x: -100, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
            ...
            >
              <Nav.Link as={Link} className='text-light' to="/#about" scroll={scrollWithOffset}>Compétences et Expériences</Nav.Link>
            </motion.div>
            <motion.div
              initial={{ x: -100, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
            ...
            >
              <Nav.Link as={Link} className='text-light' to="/#contact" scroll={scrollWithOffset}>Contact</Nav.Link>
            </motion.div>
          </Nav>
        </Navbar.Collapse>
      </Container>
